...
import providerTierRoutes from './provider-tier.route';
import deviceTypeGroupRoutes from './device-type-group.route';
import servicePartPricingRoutes from './service-part-pricing.route';
...
router.use('/provider-tiers', providerTierRoutes);
router.use('/device-type-groups', deviceTypeGroupRoutes);
router.use('/service-part-pricing', servicePartPricingRoutes);
